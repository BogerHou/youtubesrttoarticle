...
![28 个 App 组合收入中的 80/20 模型](../illustrations/28-apps-10k-month/gemini/01-infographic-portfolio-80-20.png)
...
![从关键词到构建决策的验证流程](../illustrations/28-apps-10k-month/gemini/02-flowchart-keyword-validation.png)
...
![28 个 App 背后的 6 步发布闭环](../illustrations/28-apps-10k-month/gemini/03-framework-six-step-release-loop.png)
...
![月入 1 万美元 App 组合背后的轻量工具和成本结构](../illustrations/28-apps-10k-month/gemini/04-infographic-lean-tool-cost-stack.png)
